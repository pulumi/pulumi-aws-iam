 ...
 * 
 */
public final class EKSExternalDNSPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final EKSExternalDNSPolicyArgs Empty = new EKSExternalDNSPolicyArgs();
    ...
    /**
     * @return Determines whether to attach the External DNS IAM policy to the role.
     * 
     */
    ...
    /**
     * @return Route53 hosted zone ARNs to allow External DNS to manage records. If not provided,
     * the default ARN &#34;arn:aws:route53:::hostedzone/*&#34; will be applied.
     * 
     */
    ...
    private EKSExternalDNSPolicyArgs() {}

    private EKSExternalDNSPolicyArgs(EKSExternalDNSPolicyArgs $) {
        this.attach = $.attach;
    ...
    public static Builder builder(EKSExternalDNSPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EKSExternalDNSPolicyArgs();
        }

        public Builder(EKSExternalDNSPolicyArgs defaults) {
            $ = new EKSExternalDNSPolicyArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param attach Determines whether to attach the External DNS IAM policy to the role.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param hostedZoneArns Route53 hosted zone ARNs to allow External DNS to manage records. If not provided,
         * the default ARN &#34;arn:aws:route53:::hostedzone/*&#34; will be applied.
         * 
         * @return builder
         * 
        ...
        public EKSExternalDNSPolicyArgs build() {
